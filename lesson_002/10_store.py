...
# print('lamp_code = ', lamp_code)
# print('lamp_item = ', lamps_item)
# print('lamp_quantity = ', lamps_quantity)
# print('lamp_price = ', lamps_price)
...
print('Стул -', store[ goods['Стул'] ][0]['quantity'] + \
