...
#       Сохраним количество и общую стоимость товаров в словарь

final_price = {}  # Здесь будем хранить финальную стоимость по каждому товару

for furniture in goods:
    price = 0  # Стоимоть товара
    count = 0  # Количество товара
    for fields in store[goods[furniture]]:
        count += fields['quantity']
        price += fields['quantity'] * fields['price']

    final_price[furniture] = [count, price]

#   Выводим на печать
for furniture in final_price:
    print('%s -  %d шт, стоимость %d' % (furniture, final_price[furniture][0], final_price[furniture][1]))
# зачет!